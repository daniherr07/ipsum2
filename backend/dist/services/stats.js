...
export function calcularStats(anio, tipoBono) {
    ...
    const mejorMes = mesesConDatos.length
        ? mesesConDatos.reduce((mejor, actual) => actual.ingresos - actual.egresos > mejor.ingresos - mejor.egresos ? actual : mejor)
        : null;
    const peorMes = mesesConDatos.length
        ? mesesConDatos.reduce((peor, actual) => actual.ingresos - actual.egresos < peor.ingresos - peor.egresos ? actual : peor)
        : null;
