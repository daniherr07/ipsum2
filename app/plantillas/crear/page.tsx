...
export default function CrearPlantillaPage() {
  ...
  const handleGuardar = () => {
    Swal.fire({
      ...
      text: "Se guardará la nueva plantilla con todos los artículos",
      icon: "question",
      ...
      if (result.isConfirmed) {
        console.log("Plantilla creada:", { nombre, descripcion, items })
        
        Swal.fire({
          title: "¡Éxito!",
          text: "La plantilla ha sido creada correctamente",
          icon: "success",
  ...
  return (
    <>
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 space-y-6">
        {/* Main Card */}
        <section className="bg-base-200 rounded-lg shadow-md p-6 space-y-6">
          {/* Info */}
